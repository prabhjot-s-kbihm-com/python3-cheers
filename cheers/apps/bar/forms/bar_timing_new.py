...
class FormBarTiming(forms.ModelForm):
    ...
    day = forms.CharField(widget=forms.Select(choices=ModelBarTiming.DAY_CHOICES, attrs={'class': 'form-control col-md-9'}))
...
BarTimingFormSet = inlineformset_factory(ModelBar, ModelBarTiming, extra=1, exclude=())
